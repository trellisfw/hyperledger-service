...
class REST {
    ...
    constructor(param = {}){
        ...
        /* Certificates */
        self._certificates_path = "https://fs-certificate-management-integration.mybluemix.net/v2/certifications";
       ...
       if(!await self._readOnboardingTokenFromFile()) {
            ...
            return self.post(self._iam_path, self._iam_header, self._iam_body).then( (response) => {
                ...
                return self.post(self._onboarding_path, self._onboarding_header, "", self._IAM_TOKEN).then( (response) => {
                    ...
                    fs.writeFile(self._onboarding_file_name, JSON.stringify(self._ONBOARDING_TOKEN), (response) => {console.log('File written')} );
                    //self._printOnboardingToken();
                }).catch((error) => {
